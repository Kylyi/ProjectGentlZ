...
export let configInvoicingColumns = function () {
  ...
  if (!fileFound) {
    fs.writeFileSync(p, JSON.stringify([
      ...
      {"name":"Net description","value":"Network Description","editable":false,"visible":true,"alignment":"left","dataType":"string", "width": 300},
      {"name":"SWG type","value":"Switchgear Type","editable":false,"visible":true,"dataType":"string"},
      {"name":"No. of Panels","value":"Number of Panels","editable":false,"visible":true,"dataType":"number"},
      {"name":"SSO","value":"SSO","editable":false,"visible":true,"dataType":"string", "alignment": "center", "cellTemplate": "ssoTemplate"},
      {"name":"Initial BPO","value":"Initial BPO","editable":false,"visible":false,"dataType":"number"},
      {"name":"BPO","value":"Buffer Size - Overall Project","editable":false,"visible":true,"dataType":"number"},
      {"name":"INCO","value":"INCO Type","editable":false,"visible":true,"dataType":"string", "alignment": "center"},
      {"name":"Revenues","value":"Net Revenues","editable":true,"visible":true,"dataType":"number", "width": 100},
      {"name":"Priority","value":"priority","editable":false,"visible":false,"dataType":"string"},
